...
description: "ERNIE-Image는 정밀한 텍스트 렌더링, 강력한 지시사항 준수 및 내장된 프롬프트 향상기 기능을 갖춘 Baidu의 오픈소스 8B 디퓨전 트랜스포머 text-to-image 모델입니다."
...
**ERNIE-Image**는 Baidu가 개발한 오픈소스 text-to-image 모델로, Apache-2.0 라이선스를 적용했습니다. **8B** 파라미터 디퓨전 트랜스포머(DiT)를 기반으로 하며, 정밀한 텍스트 렌더링과 강력한 지시사항 준수, 구조화된 시각적 생성을 통해 고품질 이미지를 제공합니다.
...
## ERNIE-Image text-to-image 워크플로우
...
<Card title="워크플로우 다운로드" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/image_ernie_image.json">
    ERNIE-Image text-to-image 워크플로우 JSON 파일을 다운로드하세요.
  </Card>
...
<Card title="워크플로우 다운로드" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/image_ernie_image_turbo.json">
    ERNIE-Image-Turbo text-to-image 워크플로우 JSON 파일을 다운로드하세요.
  </Card>
