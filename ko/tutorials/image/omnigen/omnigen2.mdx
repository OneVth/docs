...
description: "ComfyUI OmniGen2 네이티브 워크플로우 예시 - 통합 text-to-image, 이미지 편집 및 다중 이미지 합성 모델"
...
- **text-to-image 생성**: 텍스트 프롬프트로부터 고화질이고 미학적으로 뛰어난 이미지를 생성
...
## ComfyUI OmniGen2 Text-to-Image 워크플로우
...
![text-to-image 워크플로우](https://raw.githubusercontent.com/Comfy-Org/example_workflows/main/image/omnigen2/image_omnigen2_t2i.png)
...
6. **생성 시작**: `Queue Prompt` 버튼을 클릭하거나, 단축키 `Ctrl(cmd) + Enter`를 사용해 text-to-image 생성을 실행하세요.
...
![text-to-image 워크플로우](https://raw.githubusercontent.com/Comfy-Org/example_workflows/main/image/omnigen2/image_omnigen2_image_edit.png)
