---
title: "Cosmos Predict2 Text-to-Image ComfyUI 공식 예제"
description: "이 가이드는 ComfyUI에서 Cosmos-Predict2 Text-to-Image 워크플로우를 완료하는 방법을 보여줍니다."
...
Cosmos-Predict2는 Text-to-Image(Text2Image)와 Video-to-World(Video2World)를 포함한 다양한 생성 방식을 지원하며, 산업 시뮬레이션, 자율주행, 도시 계획, 과학 연구 등 다양한 분야에서 널리 사용되고 있습니다.
...
이 가이드에서는 ComfyUI에서 **Text-to-Image** 워크플로우를 완료하는 과정을 안내합니다.
