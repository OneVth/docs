...
description: "FLUX.2 [klein] 4B에 대한 간략한 소개와 ComfyUI에서 text-to-image 및 이미지 편집 워크플로우를 실행하는 방법을 안내합니다."
...
FLUX.2 [Klein]은 Flux 제품군 중 가장 빠른 모델로, text-to-image와 이미지 편집을 하나의 컴팩트한 아키텍처로 통합했습니다. 이 모델은 인터랙티브한 워크플로우, 즉각적인 미리보기 및 지연 시간이 중요한 애플리케이션을 위해 설계되었으며, 정제된 변형을 사용하면 단일 및 다중 참조 편집에서도 강력한 품질을 유지하면서 엔드투엔드 추론 시간을 약 1초로 줄일 수 있습니다.
...
<Card title="4B text-to-image 워크플로우" icon="download" href="https://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/image_flux2_klein_text_to_image.json">
    Flux.2 Klein 4B용 text-to-image 워크플로우를 다운로드하세요.
  </Card>
...
<Card title="9B text-to-image 워크플로우" icon="download" href="http://raw.githubusercontent.com/Comfy-Org/workflow_templates/refs/heads/main/templates/image_flux2_text_to_image_9b.json">
    Flux.2 Klein 9B용 text-to-image 워크플로우를 다운로드하세요.
  </Card>
