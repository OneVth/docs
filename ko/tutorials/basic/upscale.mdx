...
2. 기본 이미지 업스케일링 수행하기
3. text-to-image 워크플로우와 업스케일링 결합하기
...
## Text-to-Image 결합 워크플로우

기본 업스케일링을 마스터한 후, 이를 [text-to-image](/ko/tutorials/basic/text-to-image) 워크플로우와 결합할 수 있습니다. text-to-image의 기본 사항은 [text-to-image 튜토리얼](/ko/tutorials/basic/text-to-image)을 참고하세요.

다음 이미지를 ComfyUI로 다운로드하고 끌어다 놓아 결합된 워크플로우를 로드하세요:
![text-to-image 업스케일 워크플로우](/images/tutorial/basic/upscale/esrgan_example.png)

이 워크플로우는 text-to-image 출력 이미지를 바로 업스케일링 노드에 연결해 최종 처리합니다.
