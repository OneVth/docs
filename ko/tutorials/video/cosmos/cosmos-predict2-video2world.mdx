...
text-to-image 섹션에 대해서는 다음 부분을 참고해 주세요:

<Card title="Cosmos Predict2 text-to-image" icon="book" href="/ko/tutorials/image/cosmos/cosmos-predict2-t2i">
  Cosmos-Predict2를 이용한 text-to-image 생성
</Card>
{/* 
<UpdateReminder/>
