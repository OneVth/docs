...
<Card title="클라우드에서 Text-to-Model 실행" icon="cloud" href="https://cloud.comfy.org/?template=api_tripo3_1_text_to_model&utm_source=docs">
    Comfy Cloud에서 Text-to-Model 워크플로우를 즉시 시험해 보세요.
  </Card>

<Card title="Text-to-Model 워크플로우 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_tripo3_1_text_to_model.json">
    JSON 파일을 다운로드하거나 템플릿 라이브러리에서 "Tripo 3.1 Text-to-Model"을 검색하세요.
  </Card>

### Image-to-Model

<Card title="클라우드에서 Image-to-Model 실행" icon="cloud" href="https://cloud.comfy.org/?template=api_tripo3_1_image_to_model&utm_source=docs">
    Comfy Cloud에서 Image-to-Model 워크플로우를 즉시 시험해 보세요.
  </Card>

<Card title="Image-to-Model 워크플로우 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_tripo3_1_image_to_model.json">
    JSON 파일을 다운로드하거나 템플릿 라이브러리에서 "Tripo 3.1 Image-to-Model"을 검색하세요.
  </Card>

### Multiview-to-Model

<Card title="클라우드에서 Multiview-to-Model 실행" icon="cloud" href="https://cloud.comfy.org/?template=api_tripo3_1_multiview_to_model&utm_source=docs">
    Comfy Cloud에서 Multiview-to-Model 워크플로우를 즉시 시험해 보세요.
  </Card>

<Card title="Multiview-to-Model 워크플로우 다운로드" icon="download" href="https://github.com/Comfy-Org/workflow_templates/blob/main/templates/api_tripo3_1_multiview_to_model.json">
