...
![ComfyUI Tripo Text to Model 단계 안내](/images/tutorial/api_nodes/tripo/tripo_text_to_model_step_guide.jpg)

이미지의 숫자를 참고해 기본적인 Text to Model 워크플로우를 완료하세요:  
...
![ComfyUI Tripo Image to Model 단계 안내](/images/tutorial/api_nodes/tripo/tripo_image_to_model_step_guide.jpg)

이미지의 숫자를 참고해 기본적인 Image to Model 워크플로우를 완료하세요:  
...
4. 모델 다운로드는 Text to Model 섹션의 지침을 참조하세요.
...
![ComfyUI Tripo multi-view to model 단계 안내](/images/tutorial/api_nodes/tripo/tripo_multiview_to_model_step_guide.jpg)

이미지의 숫자를 참고해 기본적인 multi-view to model 워크플로우를 완료하세요:  
...
5. 모델 다운로드는 Text to Model 섹션의 지침을 참조하세요.
