...
Ideogram 3.0은 Ideogram이 개발한 강력한 Text-to-Image 모델로, 사실적인 품질과 정확한 텍스트 렌더링, 일관된 스타일 제어로 유명합니다.
...
## Ideogram 3.0 파트너 노드 Text-to-Image 모드

Ideogram V3를 이미지 및 마스크 입력 없이 사용할 경우, 노드는 Text-to-Image 모드로 작동합니다.
