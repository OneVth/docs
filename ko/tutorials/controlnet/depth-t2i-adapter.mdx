...
[T2I-Adapter](https://huggingface.co/TencentARC/T2I-Adapter)는 [Tencent ARC Lab](https://github.com/TencentARC)에서 개발한 경량 어댑터로, text-to-image 생성 모델(예: Stable Diffusion)의 구조적, 색상 및 스타일 제어 능력을 향상시키기 위해 설계되었습니다.  
