...
```bash
# Nano Banana (Google Gemini Flash Image) — text-to-image 및 프롬프트 기반 편집
...
# Seedance (ByteDance) — text-to-video, 최대 1080p / 12초 클립
comfy generate seedance \
    --prompt "꽃 위에 매달린 벌새" \
    --resolution 1080p --duration 5 \
    --download hummingbird.mp4

# Seedance image-to-video — lite/i2v 변형을 선택하고 첫 프레임을 전달하세요
comfy generate seedance \
